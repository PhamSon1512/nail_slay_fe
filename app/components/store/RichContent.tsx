  ...
  return (
    <div
      className={cn(
        ...
        'prose-p:text-[#1D1D1D] dark:prose-p:text-[#FFDDE5]/90 prose-p:my-3 prose-p:leading-relaxed',
        'prose-li:text-[#1D1D1D] dark:prose-li:text-[#FFDDE5]/90 prose-li:my-1',
        'prose-ul:my-4 prose-ol:my-4',
        'prose-strong:text-[#1D1D1D] dark:prose-strong:text-[#FFF3F5]',
        'prose-h2:font-heading prose-h2:text-lg prose-h2:font-bold prose-h2:mt-6 prose-h2:mb-3 prose-h2:pb-2',
        'prose-h2:border-b prose-h2:border-primary-200/70 dark:prose-h2:border-primary-500/30',
        'prose-h2:text-[#1D1D1D] dark:prose-h2:text-[#FFF3F5]',
        'prose-h3:font-heading prose-h3:text-base prose-h3:font-semibold prose-h3:mt-5 prose-h3:mb-2',
        'prose-h3:text-[#1D1D1D] dark:prose-h3:text-[#FFF3F5]',
        'prose-h4:text-sm prose-h4:font-semibold prose-h4:mt-4 prose-h4:mb-2 prose-h4:text-[#50575e] dark:prose-h4:text-[#FFDDE5]/80',
        '[&_p>br]:block [&_p>br]:content-[""] [&_p>br]:my-2',
